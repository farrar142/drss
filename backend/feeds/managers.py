...
class RSSItemManager[T: models.Model](models.Manager[T]):
    def search(self, search) -> models.QuerySet[T]:
        ...
        search_vector = SearchVector(
            "title", weight="A", config="simple"
        ) + SearchVector("description_text", weight="B", config="simple")
