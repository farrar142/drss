...
export const en: Translations = {
  ...
  rssEverything: {
    ...
    browserServiceDesc: 'Select the browser service to use',
    browserServiceRealbrowser: 'RealBrowser',
    browserServiceRealbrowserDesc: 'Puppeteer-based, supports bot detection bypass',
    browserServiceBrowserless: 'Browserless',
    browserServiceBrowserlessDesc: 'CDP-based, lightweight processing',
    customHeaders: 'Custom Headers',
  ...
  sourceList: {
    ...
    paginationCrawl: 'Pagination Crawl',
    paginationCrawlDescription: 'Crawl multiple pages by iterating URL template variables.',
    urlTemplate: 'URL Template',
    urlTemplatePlaceholder: 'https://example.com/posts?page={page}',
    urlTemplateHint: 'Use {variable_name} format to specify variables',
    variables: 'Variables',
    variableName: 'Name',
    variableStart: 'Start',
    variableEnd: 'End',
    ...
    noVariables: 'Add at least one variable',
  },
};
