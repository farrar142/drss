...
export const ko: Translations = {
  ...
  rssEverything: {
    ...
    browserService: '브라우저 서비스',
    browserServiceDesc: '사용할 브라우저 서비스를 선택하세요',
    browserServiceRealbrowser: 'RealBrowser',
    browserServiceRealbrowserDesc: 'Puppeteer 기반, 봇 감지 우회 지원',
    browserServiceBrowserless: 'Browserless',
    browserServiceBrowserlessDesc: 'CDP 기반, 가벼운 처리',
    customHeaders: '커스텀 헤더',
    addHeader: '헤더 추가',
    headerName: '헤더 이름',
    headerValue: '헤더 값',
  ...
  sourceList: {
    ...
    paginationCrawl: '페이지네이션 크롤링',
    paginationCrawlDescription: 'URL 템플릿의 변수를 순회하며 여러 페이지를 크롤링합니다.',
    urlTemplate: 'URL 템플릿',
    urlTemplatePlaceholder: 'https://example.com/posts?page={page}',
    urlTemplateHint: '{변수명} 형태로 변수를 지정하세요',
    variables: '변수 설정',
    variableName: '변수명',
    variableStart: '시작값',
    variableEnd: '끝값',
